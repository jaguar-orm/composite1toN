...
class Author {
  ...
  String toString() => "Author($id, $id1, $name, $posts)";
}
...
class Post {
  ...
  @BelongsTo(AuthorBean, refCol: 'id1')
  int authorid1;

  static String tableName = 'post';

  String toString() => "Post($id, $authorid, $authorid1, $message)";
}
...
class PostBean extends Bean<Post> with _PostBean {
  ...
  Future createTable() {
    final st = Sql
        ...
        .addInt('authorid1', foreignTable: Author.tableName, foreignCol: 'id1');
    return execCreateTable(st);
  }
}
...
main() async {
  ...
  // Manual One-To-One preload
  {
    ...
    print(author);
    author.posts = await postBean.findByAuthor(author.id, author.id1);
    print(author);
  }
  ...
  await postBean.removeByAuthor('2', 2);
